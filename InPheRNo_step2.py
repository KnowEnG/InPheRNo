...
#    parser.add_argument('-s', '--seed', default=1011, help='seed used for random generator')
    ...
    parser.add_argument('-agp', '--A_gene_pheno', default="None", help='alpha in beta dist. of gene-pheno. If None, it is estimated from data (p-value of gene phenotype for all genes is required). Otherwise a number must be given.')
    ...
    parser.add_argument('-id', '--input_dir', default='/Users/emad2/Amin_Research/TRN/Data/TCGA_GTEX_combined', help='address of directory containing data')
    parser.add_argument('-igpa', '--input_gene_pheno_all', default='Pvalue_gene_phenotype_1vsAll_FPKM_AdrenalGland_ACC.csv', help='name of file containing gene-phenotype association p-values for all genes, only used to estimate a_gp. If None, it is assumed to be the same as -igp')
    parser.add_argument('-ido', '--input_dir_step_one', default='/Users/emad2/Amin_Research/TRN/Data/TCGA_GTEX_combined', help='address of directory containing data')
    parser.add_argument('-igp', '--input_gene_pheno', default='Pvalue_gene_phenotype_ElasticNet_1vsAll_FPKM_TCGA_all_1_100_AdrenalGland_ACC_top_1500.csv', help='name of file containing gene-phenotype association p-values')
    parser.add_argument('-itg', '--input_TF_gene', default='Pvalue_TF_gene_ElasticNet_1vsAll_FPKM_TCGA_all_1_100_AdrenalGland_ACC_top_1500.csv', help='name of file containing TF-gene correlation p-values')
    parser.add_argument('-od', '--output_dir', default='/Users/emad2/Amin_Research/TRN/Pickles/TCGA_GTEX', help='address of directory for results')
    ...
    parser.add_argument('-nr', '--num_repeat', default=100, help='Number of the repeat. Repeats are used to ensure stability of results.')
    parser.add_argument('-sr', '--start_repeat', default=0, help='Start index of the repeat. Useful if program gets killed in the middle.')
    parser.add_argument('-er', '--end_repeat', default='None', help='End index of the repeat. Useful if program gets killed in the middle.')
